...
def kNN_OOD_Enhance(root,  root_0, name, method):
    ...
    return InD_enhance_logits, OOD_enhance_logits, InD_score, OOD_score # , InD_concat_logits, OOD_concat_logits
        ...
        for pre in ['sup_vitb16_imagenet21k']: #'mae_vitb16', plant_mae_vitl16, sup_vitb16_imagenet21k
            ...
            for OOD_split in OOD_splits:
                for method in methods:
                    ...
                    InD_concat_logits, OOD_concat_logits, InD_score, OOD_score = kNN_OOD_Enhance(root, root_0, OOD_split, method)
                    get_and_print_results(None, InD_concat_logits, OOD_concat_logits, auroc_list, aupr_list, fpr_list)
