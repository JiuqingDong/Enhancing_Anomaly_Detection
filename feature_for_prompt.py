...
for dataset in datasets:
    for split in splits:
        for pre in ['imagenet22k_sup_rnx_base']: #'mae_vitb16', imagenet22k_sup_rnx_base, sup_vitb16_imagenet21k
            root = f'/data/Jiuqing/Enhance_OOD_plant_new_split/CNN_Prompt_OOD/{dataset}{split}/{pre}/lr0.0_wd0.0/'
            ...
            get_and_print_results(None, InD_logits_sum, OOD_logits_sum, auroc_list, aupr_list, fpr_list)
            # get_and_print_results(None, InD_similarity_end, OOD_similarity_end, auroc_list, aupr_list, fpr_list)
