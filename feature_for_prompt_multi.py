...
splits = ['_1', '_2', '_3', '_4', '']
methods = ['energy', 'entropy', 'var', 'msp', 'max_logits', 'kNN']
...
def Diff_kNN_OOD(root, root_0, name):
    ...
    # InD_similarity_diff = InD_similarity_end - InD_similarity_start
    # OOD_similarity_diff = OOD_similarity_end - OOD_similarity_start
    # InD_logits_diff = 2 - np.max(InD_similarity_diff, axis=1)
    # OOD_logits_diff = 2 - np.max(OOD_similarity_diff, axis=1)
...
#         for pre in ['sup_vitb16_imagenet21k']:#'mae_vitb16',
#             for name in names:
#                 roo# t = f'/data/Jiuqing/Enhance_OOD_plant_new_split/Prompt_OOD/{dataset}{split}/{pre}/lr0.0_wd0.0/'
#                 root_0 = f'/data/Jiuqing/Enhance_OOD_plant_new_split/Finetune_OOD/{dataset}{split}/{pre}/lr0.0_wd0.0/'
#                 print(root, name, root_0)
#                 InD_logits_sum, OOD_logits_sum, InD_logits_diff, OOD_logits_diff = Diff_kNN_OOD(root, name, root_0)
#                 # print("diff")
...
#                 root_0 = f'/data/Jiuqing/Enhance_OOD_plant_new_split/Finetune_OOD/{dataset}{split}/{pre}/lr0.0_wd0.0/'
#                 print(root, name, root_0)
#                 # InD_concat_logits, OOD_concat_logits = concat_kNN_OOD(root, name, root_0)
#                 # get_and_print_results(None, InD_concat_logits, OOD_concat_logits, auroc_list, aupr_list, fpr_list)
#                 InD_logits_sum, OOD_logits_sum = Diff_kNN_OOD(root, name, root_0)
#                 get_and_print_results(None, InD_logits_sum, OOD_logits_sum, auroc_list, aupr_list, fpr_list)
        ...
        for pre in ['sup_vitb16_imagenet21k']: #'mae_vitb16', plant_mae_vitl16, sup_vitb16_imagenet21k
            ...
            for OOD_split in OOD_splits:
                for method in methods:
                    ...
                    InD_concat_logits, OOD_concat_logits, InD_score, OOD_score = kNN_OOD_Enhance(root, OOD_split, root_0, method)
                    get_and_print_results(None, InD_concat_logits, OOD_concat_logits, auroc_list, aupr_list, fpr_list)
